                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12 form-group">
                            {!! Form::label('type', 'Tipas', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
                            <div class="col-md-9 col-sm-9 col-xs-12">
                            {!! Form::text('type', null, ['class' => 'form-control', 'placeholder'=>'Tipas']) !!}
                            </div>
                        </div>

                        <div class="col-md-9 col-sm-9 col-xs-12 form-group">
                            {!! Form::label('comp_id', 'Įmonės kodas', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
                            <div class="col-md-9 col-sm-9 col-xs-12">
                            {!! Form::text('comp_id', null, ['class' => 'form-control has-feedback-right', 'placeholder'=>'Įmonės kodas']) !!}
                            </div>
                        </div>

                        <div class="col-md-9 col-sm-9 col-xs-12 form-group">
                            {!! Form::label('comp_vat', 'PVM kodas', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
                            <div class="col-md-9 col-sm-9 col-xs-12">
                            {!! Form::text('comp_vat', null, ['class' => 'form-control', 'placeholder'=>'PVM kodas']) !!}
                            </div>
                        </div>
                        ...
                        {!! Form::close() !!}
                            ...
                            {{--<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">--}}
                                {{--{!! Form::select('found_clients[]',null, null, ['class' => 'form-control has-feedback-left js-select-search', 'placeholder'=>'Pasirinkite klientą']) !!}--}}
                                {{--<select name="found_clients[]" class="form-control has-feedback-left js-select-search"></select>--}}
                            {{--</div>--}}
                            {{--</form>--}}
